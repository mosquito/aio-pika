...
:::{warning}
This is a beta version of the port from [official tutorial](https://www.rabbitmq.com/tutorials/tutorial-four-python.html). Please when you found an
...
:::{note}
This material was adopted from [official tutorial](https://www.rabbitmq.com/tutorials/tutorial-four-python.html) on **rabbitmq.org**.
:::
