...
:::{warning}
This is a beta version of the port from [official tutorial](https://www.rabbitmq.com/tutorials/tutorial-three-python.html). Please when you found an
...
:language: python
:start-after: begin-declare-exchange
:end-before: end-declare-exchange
```
...
```{literalinclude} examples/3-publish-subscribe/emit_log.py
:language: python
:start-after: begin-publish-message
:end-before: end-publish-message
```
...
:language: python
:start-at: queue = await channel.declare_queue(exclusive=True)
:end-at: queue = await channel.declare_queue(exclusive=True)
```
...
```{literalinclude} examples/3-publish-subscribe/receive_logs.py
:language: python
:start-after: begin-exchange-and-binding
:end-before: end-exchange-and-binding
```
...
:::{note}
This material was adopted from [official tutorial](https://www.rabbitmq.com/tutorials/tutorial-three-python.html) on **rabbitmq.org**.
:::
