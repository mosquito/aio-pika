...
class Connection(amqp_object.Class):
    ...
    class Start(amqp_object.Method):
        ...
        def decode(self, encoded, offset=0):
            self.version_major, self.version_minor = struct.unpack_from(
                'BB', encoded, offset
            )

            offset += 2
            self.server_properties, offset = codec.decode_table(encoded, offset)
        ...
        def encode(self):
            ...
            codec.encode_table(pieces, self.server_properties)
    ...
    class StartOk(amqp_object.Method):
        ...
        def decode(self, encoded, offset=0):
            self.client_properties, offset = codec.decode_table(encoded, offset)
            self.mechanism, offset = codec.decode_short_string(encoded, offset)
            length = struct.unpack_from('>I', encoded, offset)[0]
            offset += 4
            ...
            try:
                ...
                pass
            offset += length
            self.locale, offset = codec.decode_short_string(encoded, offset)
            return self

        def encode(self):
            pieces = list()
            codec.encode_table(pieces, self.client_properties)
            assert isinstance(self.mechanism, (str, bytes)), \
                'A non-string value was supplied for self.mechanism'

            codec.encode_short_string(pieces, self.mechanism)
            ...
            codec.encode_short_string(pieces, self.locale)
            return pieces
    ...
    class Open(amqp_object.Method):
        ...
        def decode(self, encoded, offset=0):
            self.virtual_host, offset = codec.decode_short_string(
                encoded, offset
            )
            self.capabilities, offset = codec.decode_short_string(
                encoded, offset
            )
        ...
        def encode(self):
            ...
            codec.encode_short_string(pieces, self.virtual_host)
            assert isinstance(self.capabilities, (str, bytes)), \
                'A non-string value was supplied for self.capabilities'

            codec.encode_short_string(pieces, self.capabilities)
            bit_buffer = 0
            if self.insist:
    ...
    class OpenOk(amqp_object.Method):
        ...
        def decode(self, encoded, offset=0):
            self.known_hosts, offset = codec.decode_short_string(encoded, offset)
            return self
        ...
        def encode(self):
            ...
            codec.encode_short_string(pieces, self.known_hosts)
            return pieces
    ...
    class Close(amqp_object.Method):
        ...
        def decode(self, encoded, offset=0):
            ...
            offset += 2
            self.reply_text, offset = codec.decode_short_string(encoded, offset)
        ...
        def encode(self):
            ...
            codec.encode_short_string(pieces, self.reply_text)
    ...
    class Blocked(amqp_object.Method):
        ...
        def decode(self, encoded, offset=0):
            self.reason, offset = codec.decode_short_string(encoded, offset)
            return self
        ...
        def encode(self):
            ...
            codec.encode_short_string(pieces, self.reason)
            return pieces
...
class Channel(amqp_object.Class):
    ...
    class Open(amqp_object.Method):
        ...
        def decode(self, encoded, offset=0):
            self.out_of_band, offset = codec.decode_short_string(encoded, offset)
            return self
        ...
        def encode(self):
            ...
            codec.encode_short_string(pieces, self.out_of_band)
            return pieces
...
class Access(amqp_object.Class):
    ...
    class Request(amqp_object.Method):
        ...
        def __init__(self, realm='/data', exclusive=False,
                     passive=True, active=True, write=True, read=True):
            self.realm = realm
        ...
        def decode(self, encoded, offset=0):
            self.realm, offset = codec.decode_short_string(encoded, offset)
            bit_buffer = struct.unpack_from('B', encoded, offset)[0]
            offset += 1
        ...
        def encode(self):
            ...
            codec.encode_short_string(pieces, self.realm)
            bit_buffer = 0
...
class Exchange(amqp_object.Class):
    ...
    class Declare(amqp_object.Method):
        ...
        def decode(self, encoded, offset=0):
            self.ticket = struct.unpack_from('>H', encoded, offset)[0]
            offset += 2
            self.exchange, offset = codec.decode_short_string(encoded, offset)
            self.type, offset = codec.decode_short_string(encoded, offset)
            bit_buffer = struct.unpack_from('B', encoded, offset)[0]
            offset += 1
            ...
            (self.arguments, offset) = codec.decode_table(encoded, offset)
            return self
        ...
        def encode(self):
            ...
            codec.encode_short_string(pieces, self.exchange)
            assert isinstance(self.type, (str, bytes)), \
                'A non-string value was supplied for self.type'
            codec.encode_short_string(pieces, self.type)
            bit_buffer = 0
            if self.passive:
                bit_buffer = bit_buffer | (1 << 0)
            if self.durable:
            ...
            if self.nowait:
                bit_buffer = bit_buffer | (1 << 4)
            pieces.append(struct.pack('B', bit_buffer))
            codec.encode_table(pieces, self.arguments)
            return pieces
    ...
    class Bind(amqp_object.Method):
        ...
        def decode(self, encoded, offset=0):
            self.ticket = struct.unpack_from('>H', encoded, offset)[0]
            offset += 2
            self.destination, offset = codec.decode_short_string(encoded, offset)
            self.source, offset = codec.decode_short_string(encoded, offset)
            self.routing_key, offset = codec.decode_short_string(encoded, offset)
            bit_buffer = struct.unpack_from('B', encoded, offset)[0]
            offset += 1
...
class Queue(amqp_object.Class):
    ...
    class Declare(amqp_object.Method):
        ...
        def decode(self, encoded, offset=0):
            self.ticket = struct.unpack_from('>H', encoded, offset)[0]
            offset += 2
            self.queue, offset = codec.decode_short_string(encoded, offset)
            bit_buffer = struct.unpack_from('B', encoded, offset)[0]
            offset += 1
            self.passive = (bit_buffer & (1 << 0)) != 0
            self.durable = (bit_buffer & (1 << 1)) != 0
        ...
        def encode(self):
            ...
            codec.encode_short_string(pieces, self.queue)
            bit_buffer = 0
            if self.passive:
                bit_buffer = bit_buffer | (1 << 0)
            if self.durable:
...
class Basic(amqp_object.Class):
    ...
    class Consume(amqp_object.Method):
        ...
        def decode(self, encoded, offset=0):
            ...
            offset += 2
            self.queue, offset = codec.decode_short_string(encoded, offset)
            self.consumer_tag, offset = codec.decode_short_string(
                encoded, offset
            )
            bit_buffer = struct.unpack_from('B', encoded, offset)[0]
            offset += 1
        ...
        def encode(self):
            ...
            codec.encode_short_string(pieces, self.consumer_tag)
            bit_buffer = 0
    ...
    class GetEmpty(amqp_object.Method):
        ...
        def decode(self, encoded, offset=0):
            self.cluster_id, offset = codec.decode_short_string(encoded, offset)
            return self
        ...
        def encode(self):
            ...
            codec.encode_short_string(pieces, self.cluster_id)
            return pieces
...
class BasicProperties(amqp_object.Properties):
    ...
    def decode(self, encoded, offset=0):
        ...
        if flags & BasicProperties.FLAG_CONTENT_TYPE:
            self.content_type, offset = codec.decode_short_string(encoded,
                                                                  offset)
        else:
            self.content_type = None

        if flags & BasicProperties.FLAG_CONTENT_ENCODING:
            self.content_encoding, offset = codec.decode_short_string(encoded,
                                                                      offset)
        else:
            self.content_encoding = None

        if flags & BasicProperties.FLAG_HEADERS:
            (self.headers, offset) = codec.decode_table(encoded, offset)
        else:
            self.headers = None
        ...
        if flags & BasicProperties.FLAG_CORRELATION_ID:
            self.correlation_id, offset = codec.decode_short_string(encoded,
                                                                    offset)
        else:
            self.correlation_id = None

        if flags & BasicProperties.FLAG_REPLY_TO:
            self.reply_to, offset = codec.decode_short_string(encoded, offset)
        else:
            self.reply_to = None

        if flags & BasicProperties.FLAG_EXPIRATION:
            self.expiration, offset = codec.decode_short_string(encoded, offset)
        else:
            self.expiration = None

        if flags & BasicProperties.FLAG_MESSAGE_ID:
            self.message_id, offset = codec.decode_short_string(encoded, offset)
        else:
        ...
        if flags & BasicProperties.FLAG_USER_ID:
            self.user_id, offset = codec.decode_short_string(encoded, offset)
        else:
            self.user_id = None

        if flags & BasicProperties.FLAG_APP_ID:
            self.app_id, offset = codec.decode_short_string(encoded, offset)
        else:
            self.app_id = None
    ...
    def encode(self):
        ...
        if self.content_type is not None:
            ...
            codec.encode_short_string(pieces, self.content_type)
        ...
        if self.content_encoding is not None:
            ...
            codec.encode_short_string(pieces, self.content_encoding)

        if self.headers is not None:
            flags = flags | BasicProperties.FLAG_HEADERS
            codec.encode_table(pieces, self.headers)
        ...
        if self.correlation_id is not None:
            ...
            codec.encode_short_string(pieces, self.correlation_id)
        ...
        if self.reply_to is not None:
            ...
            codec.encode_short_string(pieces, self.reply_to)
        ...
        if self.expiration is not None:
            ...
            codec.encode_short_string(pieces, self.expiration)
        ...
        if self.message_id is not None:
            ...
            codec.encode_short_string(pieces, self.message_id)
        ...
        if self.user_id is not None:
            ...
            codec.encode_short_string(pieces, self.user_id)
        ...
        if self.app_id is not None:
            ...
            codec.encode_short_string(pieces, self.app_id)
